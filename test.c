...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/15 03:06:40 by codespace         #+#    #+#             */
/*   Updated: 2023/08/15 03:40:05 by codespace        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	ft_snprintf(output, sizeof(output), "Value: %d, String: %s Test: %s %d", 42, "Hello", "Hi", 24);
	printf("Output: %s\n", output);
	return (0);
}
